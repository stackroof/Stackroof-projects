...
+(function (a) {
    ...
    (d.DEFAULTS = { delay: 500, html: !1, disable: !0, custom: {}, errors: { match: "Does not match", minlength: "Not long enough" }, feedback: { success: "glyphicon-ok", error: "glyphicon-warning-sign" } }),
        ...
        (d.prototype.validateInput = function (b) {
            ...
            if ((c.is('[type="radio"]') && (c = this.$element.find('input[name="' + c.("name") + '"]')), this.$element.trigger((b = a.Event("validate.bs.validator", { relatedTarget: c[0] }))), !b.isDefaultPrevented())) {
                var e = this;
        ...
        (d.prototype.runValidators = function (b) {
            ...
            return (
                ...
                !e.length && !e.length>=5 && b.val() && b.data("remote")
